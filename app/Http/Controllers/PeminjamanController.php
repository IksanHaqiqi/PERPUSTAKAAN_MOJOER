...
//     {
//         $peminjamans = Peminjaman::with('lemari','user')->get();
...
//         // Tambah kembali stok bukunya
//         $lemari = $peminjaman->lemari;
//         if ($lemari) {
//             $lemari->increment('stock');
//         }

//         $peminjaman->delete();

//         return back()->with('success', 'Peminjaman berhasil dihapus dan stok dikembalikan');
//     }
...
// {
//     $peminjamans = Peminjaman::with('lemari', 'user')->get();
//     return view('peminjaman.status', compact('peminjamans'));
// }
