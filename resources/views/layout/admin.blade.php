...
<head>
    ...
    <!-- Favicon and Icons -->
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('Template-ui/assets/img/apple-icon.png') }}">
    <link rel="icon" type="image/png" href="{{ asset('Template-ui/assets/img/favicon.png') }}">
    ...
    <!-- Main CSS -->
    <link id="pagestyle" href="{{ asset('Template-ui/assets/css/soft-ui-dashboard.css?v=1.1.0') }}" rel="stylesheet" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />


    <!-- Nepcha Analytics -->
    <script defer data-site="YOUR_DOMAIN_HERE" src="https://api.nepcha.com/js/nepcha-analytics.js"></script>
    <script src="https://kit.fontawesome.com/ID_KIT_ANDA.js" crossorigin="anonymous"></script>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                target="_blank">
                <img src="{{ asset('Template-ui/assets/img/logo-ct-dark.png') }}" class="navbar-brand-img h-100"
                    alt="main_logo">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('chart.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Statistik Peminjaman</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('peminjaman.status') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                 ...
                 <li class="nav-item">
                    <a class="nav-link  " href="{{ route('berita.status') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
 ...
 @yield('berita')
    ...
    <!--   Core JS Files   -->
    <script src="{{ asset('Template-ui/assets/js/core/popper.min.js') }}"></script>
    <script src="{{ asset('Template-ui/assets/js/core/bootstrap.min.js') }}"></script>
    ...
    <script src="{{ asset('Template-ui/assets/js/soft-ui-dashboard.min.js?v=1.1.0') }}"></script>
